...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--penalize_vertex_loss', action='store_true',
                             help='')
    self.parser.add_argument('--depth_adjustment_type', default=None,
                             choices=[None, 'linear','exp', 'quad', 'log'],
                             help='Different types of local-loss like depth adjustments')
    self.parser.add_argument('--m', type=float, default=100,
                             help='')
    self.parser.add_argument('--factor', type=float, default=20,
                             help='')
    # test
